...
BASE_MODEL_DOWNLOAD_URLS = [
    "https://huggingface.co/MachineDelusions/RIFE/resolve/main/"
]
...
def get_ckpt_container_path(model_type):
    if COMFY_FOLDER_PATHS_AVAILABLE:
        try:
            ...
            print(
                f"ComfyUI-Frame-Interpolation: Failed to use ComfyUI folder paths ({e}), falling back to local directory")
